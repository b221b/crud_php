...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 17 2024 г., 15:09
...
CREATE TABLE `models` (
  ...
  `obivka` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `engine_power` int NOT NULL,
  `door_number` int NOT NULL,
  `korobka_peredach` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Ford Focus', 'Красный', 'Кожа', 2001, 4, 'Автомат', 1, 1),
...
CREATE TABLE `postavshiki` (
  `id` int NOT NULL,
  `name_firma` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `price_list` (
  ...
  `coast` int NOT NULL,
  `podgotovka` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
